...
-- test "REVDATE"
----------------------------------------------------------------------------------------------------
call REVDATE_create('toto', 'modification_date');
call REVDATE_disable('toto', 'modification_date');
call REVDATE_enable('toto', 'modification_date');
call REVDATE_drop('toto', 'modification_date');

-- list created triggers
SELECT tgname AS trigger_name
FROM pg_trigger
WHERE tgrelid = 'toto'::regclass
